...
export const get = (page, limit, search) => axiosClient.get("/chemistries", { params: { page, limit, search } })

export const create = data => axiosClient.post("/chemistries", data)

export const update = data => axiosClient.put(`/chemistries/${data._id}`, data)
